...
{inputs, pkgs, ...}: let
  ...
  pyprojectOverrides = final: prev:
    ...
    in {
      ...
      cairocffi = nixpkgsPrebuiltTransformer "cairocffi"; # OSError: no library called "cairo-2" was found
      xcffib = nixpkgsPrebuiltTransformer "xcffib"; # OSError: cannot load library 'libxcb.so'
    };
